                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="forms-sample">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                       <textarea class="text-area" rows="8" name="cat_desc" placeholder="Description"></textarea>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-lg-8 d-flex flex-column">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-description">categories Info <code>.table-hover</code></p>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td >
                                                            ...
                                                            <a  class="ms-2" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                              ...
                                                              <div class="modal-dialog">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                  ...
                                                                  <h2 class="mb-4">Are you sure?</h2>
                                                                     ...
                                                                     <button type="button" class="btn btn-md btn-success">No</button>
